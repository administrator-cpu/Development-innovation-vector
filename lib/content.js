...
export const steps = [
  { n: 1, title: 'Read what exists', line: 'Sheets, scripts, legacy systems — we start by understanding them.', rotate: '-6deg', lift: '10px', image: '/images/step-1.jpg', alt: 'Hands taking notes beside a glowing screen' },
  { n: 2, title: 'Scope with an engineer', line: 'The person who builds it prices it.', rotate: '-3deg', lift: '4px', image: '/images/step-2.avif', alt: 'Engineer lit by a monitor while scoping work' },
  { n: 3, title: 'Build in stages', line: 'Shipped in weeks you can use, not quarters.', rotate: '0deg', lift: '0px', image: '/images/step-3.jpg', alt: 'Light falling through a built structure' },
  { n: 4, title: 'Migrate and host', line: 'Onto our own metal, in India.', rotate: '3deg', lift: '4px', image: '/images/step-4.jpg', alt: 'Reflection across glass and a distant horizon' },
  { n: 5, title: 'Watch it for years', line: 'Our monitoring, our engineers, our phone.', rotate: '6deg', lift: '10px', image: '/images/step-5.avif', alt: 'Warm light in a dark operations room' },
];
