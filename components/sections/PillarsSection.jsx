    ...
    >
      <Reveal>
        ...
        <p className="mx-auto mt-3.5 max-w-[52ch] text-[15px] leading-[1.55] text-muted">
          Software, infrastructure and the people who run both — so the thing you bought keeps working after
          the invoice is paid.
        </p>
      </Reveal>
      ...
      <div className="mt-10 grid grid-cols-1 gap-4 text-left sm:gap-5 md:grid-cols-3">
        {pillars.map((pillar, i) => (
          ...
          <Reveal key={pillar.n} as="article" delay={i * 0.09} className="rounded-[18px] border …">
            <div className="relative aspect-4/3 overflow-hidden rounded-xl bg-line">
              <Parallax distance={44} className="absolute -inset-y-[8%] inset-x-0">
                <Image src={pillar.image} alt={pillar.alt} fill sizes="(max-width: 768px) 100vw, 420px" className="object-cover" />
              </Parallax>
            </div>
